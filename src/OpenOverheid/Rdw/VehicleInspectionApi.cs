...
{
    /// <summary>
    /// The API for getting vehicle inspection dates.
    /// </summary>
    /// <seealso cref="OverheidApiBase" />
    public class VehicleInspectionApi : OverheidApiBase
    {
        private const string ExaminationExpirationUrl = "https://opendata.rdw.nl/resource/vkij-7mwc.json";

        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleInspectionApi"/> class.
        /// </summary>
        public VehicleInspectionApi()
            : base()
        {
        }
        ...
        public VehicleInspectionApi(HttpClient client)
            : base(client)
        {
        }
        ...
        public async Task<DateTime> GetAsync(string licensePlate)
        {
        ...
        /// <param name="licensePlate">The license plate.</param>
        /// <returns>The date on which the examination expires.</returns>
        public DateTime Get(string licensePlate)
        {
            licensePlate = NormalizeLicensePlate(licensePlate);
        ...
        public Dictionary<string, DateTime> GetAll()
            => GetAll(int.MaxValue, 0);
        ...
        /// <returns>Get all examination expiration dates of registered vehicles.</returns>
        public Dictionary<string, DateTime> GetAll(int limit, int offset)
        {
        ...
        /// <param name="offset">The offset of entries where to start for pagination.</param>
        /// <returns>Get all examination expiration dates of registered vehicles.</returns>
        public async Task<Dictionary<string, DateTime>> GetAllAsync(int limit, int offset)
        {
